...
function productDatabaseSetup() {
	...
	prodText = [
		...
		"GLYCOLAC FOAM", "#Udder des", ",,1.8,3", "", "kg,kg,kg,kg", "", "GLYCOLAC-FOAM", "Désinfectant moussant à appliquer sur les trayons avant la traite, à base d’acide lactique et d’acide glycolique. Le produit s’essuie avec un papier à usage unique ou avec une lavette. Laisse la peau du trayon souple et adoucie.|||", "2x2,10,20,60,200,1000", "", "kg,kg,kg,kg", "hygiène mamelle*LSA®,udder hygiene*LSA®,,", "", "manual", "AOC(after)", "", "cow,goat,sheep", "", "AB", "B",
		...
		"GLYCOLAC FILM", "#Udder Film", "3", "", "kg,kg,kg,kg", "", "GLYCOLAC-FILM", "Produit barrière à utiliser après la traite à base d’acide lactique et d’acide glycolique. Laisse un film protecteur sur le trayon, qui s’enlève facilement à la traite suivante.|||", "2,10,22,60,220,1000", "", "kg,kg,kg,kg", "hygiène mamelle*LSA®,udder hygiene*LSA®,,", "", "manual", "", "", "cow", "", "AB", "B",
		"TRAYFILM +", "#Udder Film", "3", "", "kg,kg,kg,kg", "", "TRAYFILM-+", "Produit barrière à utiliser après la traite à base d’acide lactique et d’acide glycolique. Laisse un film protecteur sur le trayon, qui s’enlève facilement à la traite suivante.|||", "2,10,22,60,220,1000", "", "kg,kg,kg,kg", "hygiène mamelle*LSA®,udder hygiene*LSA®,,", "", "manual", "", "", "cow", "", "AB", "B",
		...
		"GLYCOLAC SPRAY", "#Udder des", "3,7*1.5,3.5*1.64,3.78", "420", "kg,kg,kg,kg", "", "GLYCOLAC-SPRAY", "Désinfectant pour les trayons à pulvériser, à base d’acide lactique et d’acide glycolique. Utilisation possible en robot ou traite conventionnelle, avant et après la traite.|||", "4x5,10,22,60,220,1000", "", "kg,kg,kg,kg", "hygiène mamelle*LSA®,udder hygiene*LSA®,,", "", "manual", "", "", "cow,goat,sheep", "", "AB", "B",
