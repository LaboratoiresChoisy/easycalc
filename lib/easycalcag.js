...
function modalInit() {
	...
	var modals = ['#modalVF1,1600', '#modalVF2,700', '#modalVF3,1600', '#modalVF4,1600', '#modalVF5,700'];
...
function createModalVFTable( target, dim, type ) {
	...
	var myDiv      = $( target ),
	    ...
	    addClass2,
	    htmlX      = N,
	    rowInfos   = [1, 0, 1, 1, 0], // This is where (index) the row info begins vs each table type
	...
	$.each( modalVFNoteText, function ( index, value ) {
		...
		value = value.split( CO );
		if ( value[ type - 1 ] * 1 ) {
			htmlX += '<div class="modalnote">' + value[ 5 + lang ].replace( PO, CO ) + NBSP + CI + NBSP + ED;
...
function appendSliderItems() {
	...
	productRange = [
		...
		"#udderbeforem",
		"HYPRED QUICK SPRAY", "SPRAY 2A", "PREFOAM +", "BESTFOAM +", "WIPES LSA", "G-MIX POWER", "LIQUIM'IX", "LIQ-IO 2500", "LIQ-IO C", "TRAYOR", "TRAYOLINE", "NATIGREEN", "ANTI-GERM FRESH TRITEX",
		...
		"#udderafterm",
		"HM VIR SPRAY", "NOVA TREMP'", "HM VIR FILM", "COSMETO'FLASH", "HYPRED QUICK SPRAY", "SPRAY 2A", "DIP BLUE", "GOLDEN MIX", "SYN'ERGIX", "G-MIX", "POWER BLUE", "EXCEL'MIX", "TRAYMIX", "DIP-IO", "DERMADINE", "LIQ-IO", "IODIP",
		...
		"HYPROCLOR ED", "ACTIFLASH 5+", "PERFO GRIF+", "DUOGRIFF",
		"#internalcircuits",
...
function textDatabaseSetup() {
	...
	modalVFNoteText = [
		...
		"0,0,0,1,0,Graminés : 4.5 T de MS (15 T brutes/ha à 30 de MS),,,",
		"1,0,1,0,0,Dérobées : 4.5 T de MS (15 T brutes/ha à 30 de MS),,,",
		"1,0,1,0,0,Prairies naturelles : 3.5 T de MS (12T brutes/ha à 30% de MS),,,",
		"1,0,1,0,0,Méteil : 9 T de MS (36 T brutes/ha à 25 de MS),,,",
		"0,1,1,0,1,Ensilage de maïs : 13 T de MS (40 T brutes à 33% de MS),,,",
		"0,1,1,0,1,Maïs epi : 6 T de MS ( 11 T brutes/ha à 55% de MS),,,",
		"0,1,1,0,1,Maïs grain humide : 5.2 T de MS (8 T brutes/ha à 65% de MS),,,",
		"1,0,1,0,0,Luzerne :  4.5 T de MS (16 T brutes/ha à 28% de MS),,,"
	];
...
function productDatabaseSetup() {
	...
	prodText = [
		...
		"SANIKARST", "#Water TT", "0.0005-0.0012", "", "kg,kg,kg,kg", "", "ANTI-GERM-STAB-O", "Additif stabilisant antitartre. A utiliser en complément de Sanicristal pour la désinfection de l'eau. Dosage : 1/2 volume de Sanikarst pour un volume de Sanicristal. |||", "10", "1.17", "kg,kg,kg,kg", "traitement eau,water treatment,,", "", "manual", "", "", "cow,goat", "022003", "", "",
		...
		"BOVIFORM NORBIL", "#Nutri", "2", "", "bolus,bolus,Dosen,dosis", "", "BOVIFORM-NORBIL", "Bolus démarrage de lactation : accompagnement du métabolisme énergétique, aide à la reproduction ● Libération contrôlée des éléments : apports pendant 10 jours en 1 dose (L-Carnitine, Choline, Méthionine rumino-protégées) ● Application : 2 bolus le 1er jour de la lactation|||", "12", "", "boîte(s) de &Q &P,boxes of &Q &P,,", "nutrition,nutrition,,", "", "auto", "VL,cow,kuh,vaca", "", "cow", "", "", "",
		...
		"HYDRYL", "#Nutri", "4", "", "sachet(s),bag(s),,", "", "HYDRYL", "Formule effervescente d'aide au démarrage du veau  (action protectrice) ● Transition alimentaire (entre colostrum et phase lactée), aide à la bonne hydratation en cas de troubles digestifs • Application : transition, 1 journée (2 repas/jr) - hydratation, 2 à 3 jours (2 repas/jr)|||", "16", "", "boîte(s) de &Q &P,boxes of &Q &P,,", "nutrition,nutrition,,", "", "auto", "veau,veal,kalbfleich,ternera", "", "cow", "015745", "", "",
		...
		"HYDRAVO FRV 100", "#Nutri", "6", "", "bolus,bolus,Dosen,dosis", "", "HYDRAVO-FRV-100", "Galet effervescent d'aide au démarrage du veau : transition alimentaire, aide à la bonne hydratation en cas de troubles digestifs • Application : 2 galets dans 2L d'eau chaude, 2 fois par jour pendant 2 à 3 jours|||", "100", "", "boîte(s) de &Q &P,boxes of &Q &P,,", "nutrition,nutrition,,", "", "auto", "veau,veal,kalbfleich,ternera", "", "cow", "021079", "", "",
